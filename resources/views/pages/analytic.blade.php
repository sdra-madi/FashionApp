...
<aside>
    <div class="conta">
        ...
        <div class="asidebar">
            ...
            <a href="{{ route('analytic') }}" class="active">
...
<main>
    <section class="analytics" id="analytics">
        ...
        <h1 class="heading mov or"> الإحصائيات</h1>
        <div class="insights">
            <div class="sales">
                <span class="material-symbols-outlined">
                    analytics
            ...
            <div class="sales-man">
                ...
                <div class="middlle">
                    ...
                    <div class="left">
                        <h3>نسبة المبيعات الرجالية</h3>
                        <h1>{{$total_sale_men}}%</h1>
                    </div>
                </div>
            ...
            <div class="sales-woman">
                ...
                <div class="middlle">
                    ...
                    <div class="left">
                        <h3>نسبة المبيعات النسائية</h3>
                        <h1>{{$total_sale_women}}%</h1>
                    </div>
                </div>
            ...
            <div class="sales-kids">
                ...
                <div class="middlle">
                    ...
                    <div class="left">
                        <h3>نسبة المبيعات الولادية</h3>
                        <h1>{{$total_sale_kids}}%</h1>
                    </div>
                </div>
