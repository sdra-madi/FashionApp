...
@section('content')
    ...
    <section class="products" id="products">
        ...
        <h1 class="heading mov or u"> تعديل تفاصيل الشحن</h1>
        ...
        <section class="feat" id="featured">
            <div class="roww">
                <form class="contentt" action="{{ route('store_charge',$charge[0]->id) }}" method="post">
                    @csrf
                    <div class="section-two">
                        <div class="namee">
                            <label for="">نوع الشحن:</label><br>
                            <br>
                            <input type="text" id="text" name="type" placeholder="{{$charge[0]->type}}" class="in1 ">
                            <h5 style="color:red"> @error('type')
                                    {{ $message }}
                                @enderror
                            </h5>
                            <br>
                        ...
                        <div class="namee">
                            <label for="cost"> تكلفة الشحن:</label><br>
                            <br>
                            <input type="number" id="cost" name="price"  placeholder="{{$charge[0]->price}}"class="in1 ">
                            <h5 style="color:red"> @error('price')
                                    {{ $message }}
                                @enderror
                            </h5>
                            <br>
                        ...
                        <div class="namee">
                            <label for="number"> مدة التسليم:</label><br>
                            <br>
                            <input type="number" id="number" name="durition"  placeholder="{{$charge[0]->durition}}"class="in1 ">
                            <h5 style="color:red"> @error('durition')
                                    {{ $message }}
                                @enderror
                            </h5><br>
                        </div>
