...
<aside>
    ...
    <section class="products" id="products">
        ...
        <div class="gallery" id="gallery">
            ...
            <h1 class="heading mov newhead"> المنتجات النسائية </h1>
            <ul class="controls">
                <a href="{{route('women')}}" class="btn button-active" data-filter="all">الكل</a>
                @foreach ($types as $type)
                    <a href="{{route('type_products',$type->id)}}" class="btn" data-filter="dress">{{ $type->name }}</a>
                @endforeach
            </ul>
            <div class="box-container">
                @foreach ($products_women as $product)
                <div class="box dress" data-item="featured">
                    <div class="image">
