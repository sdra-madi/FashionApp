...
@section('content')
    ...
    <section class="products" id="products">
        ...
        <h1 class="heading mov or u"> ادخل تفاصيل الشحن</h1>
    ...
    @endif
        <section class="feat" id="featured">
            <div class="roww">
                <form class="contentt" action="{{ route('score_charge') }}" method="post">
@csrf
                    <div class="section-two">
                        <div class="namee">
                            <label for="">نوع الشحن:</label><br>
                            <br>
                            <input type="text" id="text" name="type" class="in1 ">
                            <h5 style="color:red"> @error('type'){{ $message }} @enderror
                            </h5><br>
                        </div>
                        <div class="namee">
                            <label for="cost"> تكلفة الشحن:</label><br>
                            <br>
                            <input type="number" id="cost" name="price" class="in1 ">
                        ...
                        <div class="namee">
                            ...
                            <br>
                            <input type="number" id="number" name="durition" class="in1 ">
