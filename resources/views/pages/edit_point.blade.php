...
@section('content')
    ...
    <section class="products" id="products">
        ...
        <h1 class="heading mov or u"> تعديل تفاصيل النقاط</h1>
    ...
    @endif
        <section class="feat" id="featured">
            <div class="roww">
                <form class="contentt" action="{{ route('store_points') }}" method="post">
                    @csrf
                    <div class="section-two">
                        <div class="namee">
                            ...
                            <input type="number" id="number" name="number"
                                placeholder="{{ $point[0]->number_of_points }}" class="in1 ch-size">
                        ...
                        <div class="namee">
                            ...
                            <br>
                            <input type="number" id="cost" name="cost" placeholder="{{ $point[0]->opposite }}"
                                class="in1"><br>
                                <h5 style="color:red"> @error('cost'){{$message}}@enderror</h5>
                        </div>
